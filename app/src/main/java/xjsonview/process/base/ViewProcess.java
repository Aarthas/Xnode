...
public class ViewProcess extends BseViewComponent {
    ...
    public void applyProperty(View hostview, String key, String value) {
        ...
        switch (key) {
            ...
            case "tag":
                ...
                break;
            case "padding":
                int padding = (int) Utils.meatureWithUnit(value);
            ...
            case "background":
                hostview.setBackgroundColor(Utils.parseColor(value));
                break;
            case "visible":
            ...
            case "margin":
                ...
                if (split.length == 1) {
                    String s = split[0];
                    marginleft = marginRight = marginTop = marginBottom = (int) Utils.meatureWithUnit(s);
                }
                else if (split.length == 4) {
                    marginleft=  (int) Utils.meatureWithUnit(split[0])  ;
                    marginRight=  (int) Utils.meatureWithUnit(split[2])  ;
                    marginTop=  (int) Utils.meatureWithUnit(split[1])  ;
                    marginBottom=  (int) Utils.meatureWithUnit(split[3])  ;
                }
    ...
    private void paddinga(View hostview, String value, int position) {
        ...
        padding[position] = (int) Utils.meatureWithUnit(value);
